...
@WebServlet("/recherche-personne.aspx")
public class RechercherServletAjax2 extends HttpServlet {
    @Override
    ...
    public void doPost(HttpServletRequest paramReq, HttpServletResponse paramResp)
        ...
        paramReq.getRequestDispatcher("/WEB-INF/recherche-partial-view2.jsp")
