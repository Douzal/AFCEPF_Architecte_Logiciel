...
public class TestAjouter {
    ...
    public void testAjoutNominal() throws QualitException {
        ...
        Assert.assertNotNull(retour.getDob());
        Assert.assertNotNull(retour.getMdp());
        Assert.assertNotNull(retour.getAdresse());
        Assert.assertEquals(persNominalExpected.getId(), retour.getId());
        Assert.assertEquals(persNominalExpected.getNom(), retour.getNom());
        Assert.assertEquals(persNominalExpected.getPrenom(), retour.getPrenom());
        Assert.assertEquals(persNominalExpected.getMail(), retour.getMail());
        Assert.assertEquals(persNominalExpected.getMdp(), retour.getMdp());
        Assert.assertEquals(persNominalExpected.getDob(), retour.getDob());
        Assert.assertEquals(persNominalExpected.getAdresse().getId(),
                            retour.getAdresse().getId());
    }
}
